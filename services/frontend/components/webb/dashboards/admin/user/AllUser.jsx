...
export default function UsersList() {
  ...
  const renderTable = (title, data, showActions) => (
    <div className="mb-10">
      <h2 className="text-3xl text-black mb-4 text-center">{title}</h2>
            ...
            <tr>
              <th className="border border-detail-yellow text-2xl py-2 text-center">
                <div className="flex gap-2 justify-center items-center">
                  <User className="text-detail-yellow" /> First name
                </div>
              </th>
              <th className="border border-detail-yellow text-2xl py-2 text-center">
                <div className="flex gap-2 justify-center items-center">
                  <User className="text-detail-yellow" /> Last name
                </div>
              </th>
              <th className="border border-detail-yellow text-2xl py-2 text-center">
                <div className="flex gap-2 justify-center items-center">
                  <Mail className="text-detail-yellow" /> Email
                </div>
              </th>
              {showActions && (
                <th className="border border-detail-yellow text-2xl py-2 text-center">
  ...
  return (
    <>
      ...
      {renderTable('User', customers, true)}
    </>
  );
}
